...
namespace server.Data.Migrations
{
    ...
    [Migration("20230505041852_create-table-refreshtoken")]
            ...
            modelBuilder.Entity("server.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 5, 11, 18, 52, 567, DateTimeKind.Local).AddTicks(6516));
            ...
            modelBuilder.Entity("server.Data.Entities.Exam", b =>
                {
                    ...
                    b.Property<DateTime>("PostedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 5, 11, 18, 52, 578, DateTimeKind.Local).AddTicks(7182));
            ...
            modelBuilder.Entity("server.Data.Entities.RefreshTokens", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 5, 11, 18, 52, 588, DateTimeKind.Local).AddTicks(1372));
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 5, 11, 18, 52, 588, DateTimeKind.Local).AddTicks(1649));
