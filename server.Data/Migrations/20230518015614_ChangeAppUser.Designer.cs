...
namespace server.Data.Migrations
{
    ...
    [Migration("20230518015614_ChangeAppUser")]
            ...
            modelBuilder.Entity("server.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 18, 8, 56, 14, 95, DateTimeKind.Local).AddTicks(3657));
            ...
            modelBuilder.Entity("server.Data.Entities.Exam", b =>
                {
                    ...
                    b.Property<DateTime>("PostedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 18, 8, 56, 14, 102, DateTimeKind.Local).AddTicks(1899));
            ...
            modelBuilder.Entity("server.Data.Entities.RefreshTokens", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 18, 8, 56, 14, 107, DateTimeKind.Local).AddTicks(3456));
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 18, 8, 56, 14, 107, DateTimeKind.Local).AddTicks(3591));
